...
- [x] **ENT-01**: Sample entities exist that can exercise CRUD, row-level, and attribute-level security end to end
- [x] **ENT-02**: Secured entity APIs have automated backend tests for allow and deny scenarios
...
*Last updated: 2026-03-25 after milestone verification sync*
*Archived: 2026-03-25 for v1.0 MVP*
