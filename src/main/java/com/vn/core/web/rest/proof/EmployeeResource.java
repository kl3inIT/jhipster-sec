...
import com.vn.core.service.proof.EmployeeService;
import java.net.URI;
...
/**
 * REST controller exposing secured CRUD endpoints for proof employees.
 */
@RestController
...
public class EmployeeResource {
    ...
    public ResponseEntity<Map<String, Object>> createEmployee(@RequestBody Map<String, Object> attributes) {
        LOG.debug("REST request to create proof employee : {}", attributes);
        Map<String, Object> result = employeeService.create(attributes);
        return ResponseEntity.created(URI.create("/api/proof/employees/" + result.get("id"))).body(result);
    }
