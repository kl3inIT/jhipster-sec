...
export function securedDetail(data) {
  const res = http.get(`${BASE_URL}/api/organizations/${ORG_ID}`, {
...
export function handleSummary(data) {
  ...
  return {
    'load-tests/results/org-detail-summary.md': md,
    'load-tests/results/org-detail-raw.json': JSON.stringify(data, null, 2),
